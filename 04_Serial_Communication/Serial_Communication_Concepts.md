...
본 문서는 STM32 기반 임베디드 시스템에서 사용되는 대표적인 직렬 통신 방식인 UART, I2C, SPI에 대한 상위 개요 문서이다.
각 통신 방식의 동작 개념, 구조적 특징, 사용 목적을 정리하고 이후 하위 문서(UART_Registers.md, I2C_Registers.md, SPI_Registers.md)에서 레지스터 단위의 상세 내용을 다룬다.
...
* Flash Memory, ADC, DAC 등 고속 데이터 전송
...
* Communication_Concepts.md : 통신 개념 및 선택 기준
* UART_Registers.md : USART 레지스터 구조 및 동작
* I2C_Registers.md : I2C 레지스터 및 상태 플래그
* SPI_Registers.md : SPI 제어 및 데이터 흐름

각 하위 문서는 STM32F10x 레퍼런스 매뉴얼 기준으로 작성되며,
Concepts 문서에서 설명한 개념을 전제로 한다.
